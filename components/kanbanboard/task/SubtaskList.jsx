...
export const SubtaskList = ({
  ...
  console.log("SubtaskList", subtasks);
      ...
      Object.keys(updatedData).forEach((key) => {
        ...
        if (key === "assignee" || key === "reporter") {
          ...
          if (
            ...
            console.log(
              `${key} changed from ${originalValue} to null (Unassigned)`
            );
            return;
          }
          ...
          if (originalId !== newId) {
            changedFields[key] =
              newValue && typeof newValue === "object"
                ? newValue._id
                : newValue;
            console.log(`${key} changed from ${originalId} to ${newId}`);
          }
        }
        // Handle date fields
          ...
          if (originalDate !== newDate) {
            ...
            console.log(`${key} changed from ${originalDate} to ${newDate}`);
          }
        }
        // Handle regular fields (strings, numbers, etc.)
          ...
          changedFields[key] = updatedData[key];
          console.log(
            `${key} changed from ${originalSubtask[key]} to ${updatedData[key]}`
          );
        }
      });
