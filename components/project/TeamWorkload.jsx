...
export const TeamWorkload = () => {
  const { allTasks, projects, teams, members, loading, error } = useMembers();
    ...
    try {
      ...
      allTasks.forEach((item) => {
        ...
        tasksToProcess.forEach((task) => {
          ...
          console.log("Teams", teamsFromTasks);
        });
      });
      ...
      console.log("Teams from tasks", teamsFromTasks);
      ...
      teamsFromTasks.forEach((team) => {
        ...
        team.members.forEach((memberId) => {
          ...
          console.log("Member Workload", memberWorkload);
        });
      });
